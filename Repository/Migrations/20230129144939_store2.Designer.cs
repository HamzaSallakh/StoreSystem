...
namespace Repository.Migrations
{
    ...
    [Migration("20230129144939_store2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Model.Buyers", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("BuyersAddress")
            ...
            modelBuilder.Entity("Domain.Model.Payments", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Domain.Model.Orders", b =>
                {
                    b.HasOne("Domain.Model.Buyers", "Buyers")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Model.Payments", b =>
                {
                    b.HasOne("Domain.Model.Orders", "Orders")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.Model.ApplicationUser", b =>
                {
                    b.OwnsMany("Domain.Model.RefreshToken", "RefreshToken", b1 =>
                        {
                            ...
                            b1.Property<DateTime>("ExpiersOn")
                                .HasColumnType("datetime2");
